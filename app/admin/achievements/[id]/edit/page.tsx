...
export default async function EditAchievementPage({params}: EditAchievementPageProps) {
	...
	const updateAchievementWithId = updateAchievement.bind(null, id);
	...
	return (
		<main className="mx-auto max-w-3xl p-8">
			...
			<h1 className="mt-6 text-3xl font-bold">Edit Achievement</h1>

			<form action={updateAchievementWithId} className="mt-8 space-y-6">
				<AdminInput label="Title" name="title" required defaultValue={achievement.title} />
