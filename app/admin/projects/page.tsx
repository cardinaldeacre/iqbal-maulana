                        ...
                        <div
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    {project.is_featured && (
                                        <span className="rounded-full bg-neutral-100 px-2 py-1 text-xs">Featured</span>
                                    )}
                                </div>
                                ...
                                {project.tech_stack.length > 0 && (
                                    <div className="mt-2 flex flex-wrap gap-2">
                                        {project.tech_stack.map((tech) => (
                                            <span key={tech} className="rounded bg-neutral-100 px-2 py-1 text-xs">
                                                {tech}
                                            </span>
                                        ))}
                                    </div>
                            ...
                            <div className="flex items-center gap-4">
                                <Link href={`/admin/projects/${project.id}/edit`} className="text-sm font-medium">
                                    Edit
                                </Link>
