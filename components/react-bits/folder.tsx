...
const Folder: React.FC<FolderProps> = ({
	...
	const paper1 = 'rgba(255, 255, 255, 0.26)';
	const paper2 = 'rgba(255, 255, 255, 0.32)';
	const paper3 = 'rgba(255, 255, 255, 0.40)';
	...
	const getOpenTransform = (index: number) => {
		if (index === 0) {
			return 'translate(-155%, -72%) rotate(-12deg)';
		}

		if (index === 1) {
			return 'translate(55%, -72%) rotate(12deg)';
		}

		if (index === 2) {
			return 'translate(-50%, -125%) rotate(2deg)';
		}
